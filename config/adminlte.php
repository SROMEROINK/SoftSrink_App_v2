...
// config\adminlte.php
    return [
        ...
        */
        ...
        'usermenu_enabled' => true, // 'true' para mostrar el menú de usuario
        'usermenu_header' => true, // 'true' para mostrar el header del usuario
        'usermenu_header_class' => 'bg-info', // 'bg-info' para cambiar el color del header
        'usermenu_image' => true, // 'true' para mostrar la imagen del usuario
        'usermenu_desc' => true, // 'true' para mostrar la descripción del usuario
        'usermenu_profile_url' => true, // 'true' para mostrar la URL del perfil del usuario
        ...
        */
        ...
        'classes_brand_text' => '',
        'classes_content_wrapper' => '', // Es todo el contenido de la página : header, sidebar, footer
        'classes_content_header' => '', // Es el header de la página, donde se encuentra el título: 'bg-primary',
        'classes_content' => '',
        'classes_sidebar' => 'sidebar-dark-success elevation-4', // Para cambiar el color del sidebar
        'classes_sidebar_nav' => '',
        ...
        */
        ...
        'menu' => [
            ...
            [
                ...
                'can' => 'ver compras', // Define el permiso necesario
                'submenu' => [
                    [
                        'text' => 'Materia_Prima',
                        'url' => '#',
                        'icon' => 'fas fa-solid fa-list-check',
                        'can' => 'ver compras', // Define el permiso necesario para acceder
                    ],
                    [
                        'text' => 'Herramental',
                        'url' => '#',
            ...
            [
                'text' => 'Herramental',
                'icon' => 'fas fa-database',
                'can' => 'ver herramental', // Define el permiso necesario
                'submenu' => [
                    [
            ...
            [
                ...
                'submenu' => [
                    [
                        ...
                        'url' => '#',
                        'icon' => 'fas fa-fw fa-solid fa-cubes',
                        'can' => 'ver calidad', // Define el permiso necesario
                    ],
                    [
                        'text' => 'Nc_Calidad',
                        'url' => '#',
