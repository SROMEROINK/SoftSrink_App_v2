        ...
        <table class="table table-bordered custom-font centered-form" id="tablaProduccion">
            <thead>
                <tr>
                    ...
                    <th class="col-editar-of">Listar OF</th>
...
<script>
    ...
    var filaBase = `<tr>
                        ...
                        <td>
                            <select class="form-control horario" justify-content: center name="horario[]">
                        ...
                        <td><button type="button" id="edit_of" class="btn btn-info">Listar_OF</button></td>
