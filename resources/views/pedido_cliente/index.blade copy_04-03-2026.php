...
*Ver el tema de los filtros de estado de las OF!*
                            ...
                            <th>
                                <select id="filtro_estado" class="form-control filtro-select">
                                    ...
                                    @foreach ($estados as $estado)
                                        <option value="{{ $estado->Estado_Plani_Id }}">{{ $estado->Nombre_Estado }}</option>
                                    @endforeach
                                </select>
                            </th> <!-- estado_planificacion -->
                           <th></th> <!-- created_at -->
                           <th></th> <!-- creator -->
                           <th></th> <!-- updated_at -->
                           <th></th> <!-- updater -->
...
$(document).ready(function() {
    ...
    ajax: {
        ...
        data: function (d) {
            ...
            d.filtro_estado_plani = $('#filtro_estado').val();
    ...
    { data: 'Plan_Estado', name: 'Plan_Estado', orderable: false, searchable: false },
